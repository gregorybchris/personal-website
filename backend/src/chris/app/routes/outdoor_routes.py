...
def get_outdoor() -> JSONResponse:
    return JSONResponse(
        {
            "cycling": fetch_dataset_json(Datasets.CYCLING_ROUTES),
            "hiking": fetch_dataset_json(Datasets.HIKING_ROUTES),
            "running": fetch_dataset_json(Datasets.RUNNING_ROUTES),
        }
    )
...
def get_outdoor_cycling() -> JSONResponse:
    return JSONResponse(fetch_dataset_json(Datasets.CYCLING_ROUTES))
...
def get_outdoor_hiking() -> JSONResponse:
    return JSONResponse(fetch_dataset_json(Datasets.HIKING_ROUTES))
...
def get_outdoor_running() -> JSONResponse:
    return JSONResponse(fetch_dataset_json(Datasets.RUNNING_ROUTES))
